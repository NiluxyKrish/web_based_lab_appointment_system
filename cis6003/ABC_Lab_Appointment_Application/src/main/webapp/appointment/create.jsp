<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="dbConnection.SessionManage"%>
      <%@ page import="controller.AppointmentController"%>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row">
                    <div class="card mb-4">
                        <h5 class="card-header">Update Appointment</h5>
                        <hr class="my-0" />
                        <div class="card-body">
                          <form id="formAccountSettings" method="post" action="UpdateAppoimentServlet" enctype="multipart/form-data">
                            ...
                            <div class="mt-2">
                              ...
                              <a href="index.jsp" class="btn btn-outline-secondary">View Appointment</a>
                            </div>
                          </form>
                        </div>
                      </div>
