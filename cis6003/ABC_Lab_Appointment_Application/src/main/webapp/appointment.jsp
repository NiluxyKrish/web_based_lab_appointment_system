<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="dbConnection.SessionManage"%>
    <%@ page import="controller.MedicalController"%>
    <%@ page import="test.MedicalTest"%>
...
<header>
    ...
    <a href="appoiment.jsp" class="btn btn-main btn-round-full">BOOK APPOINTMENT</a>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">BOOK YOUR APPOINTMENTS</h1>
        </div>
      </div>
    </div>
  </div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								<label for="medical_test">choose Medical Test</label>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="booking_time">Appointment Reservation</label>
    ...
    <div class="form-group">
        ...
        <%=(bookingDateError != null) ? "<span class=\"text-danger\">" + bookingDateError + "</span>" : ""%>
					...
					<div class="text-center makeappoinment">
						<button class="btn btn-main btn-round-full" type="submit">Make an Appointment <i class="icofont-simple-right ml-2"></i></button>
                    </div>
						  ...
						  <div class="card-data flex-fill flex-vertical">
							<div class="flex-between flex-vertical-center">
							  <div class="card-property-title">
								...
								<span>Please input the 16-digit card number located on your card.</span>
							  </div>
							</div>
							...
							<div class="flex-between">
							  <div class="card-property-title">
								...
								<span>
Please provide the expiration date of your card.</span>
							  </div>
							...
							<div class="flex-between">
							  <div class="card-property-title">
								...
								<span>Please input the card verification code located on the back of your card.</span>
							  </div>
							...
							<div class="flex-between">
							  <div class="card-property-title">
								...
								<span>Please provide the name of the cardholder as it appears on the card.</span>
							  </div>
							  <div class="card-property-value">
								<div class="input-container">
			...
			<div class="col-lg-4 col-md-12 py-5 pay hidden-element">
				...
				<div class="purchase-section flex-fill flex-vertical">
				  ...
				  <ul class="purchase-props">
					<li class="flex-between">
					  <span>Company</span>
					  <strong>ABC Medical Laboratory</strong>
					</li>
					<li class="flex-between">
					  <span>Test </span>
				...
				<div class="total-section flex-between flex-vertical-center">
				  <div class="flex-fill flex-vertical">
					<div class="total-label f-secondary-color">Payment Required</div>
					<div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<ul class="list-unstyled footer-menu lh-35">
						...
						<li><a href="appoiment.jsp">Book Appointment</a></li>
