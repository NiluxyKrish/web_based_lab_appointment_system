            ...
            <div class="card-body">
              <div class="app-brand justify-content-center">
                ...
                <img src="./front-end/images/loginlogo.png" alt="" class="img-fluid">
                  <span class="app-brand-text demo text-body fw-bolder">ABC Medical Laboratory</span>
                </a>
              </div>
              ...
              <form method="post" action="register" class="mb-3" id="register-form">
                ...
                <button class="btn btn-primary d-grid w-100 form-submit" type="submit" name="signup" id="signup" value="Register">Sign in</button>
            </form>            
          </div>
              <p class="text-center">
